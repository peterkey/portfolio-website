...
Plans:
- [x] 03-01-PLAN.md — Reorder sections, remove placeholders, fix background alternation, update Navbar
...
Plans:
- [ ] 04-01-PLAN.md — Rewrite Experience timeline order and Case Studies result fields (COPY-01, COPY-02)
